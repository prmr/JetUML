...
public class TestUsageScenariosObjectDiagram 
{
	...
	public void testDeleteObjectNodeAndNoteNode()
	{
		...
		aDiagram.addNode(aObjectNode1, new Point(20, 20), Integer.MAX_VALUE, Integer.MAX_VALUE);
		aController.getSelectionList().add(aObjectNode1);
	...
	public void testDeleteFieldNode()
	{
		...
		aController.getSelectionList().add(aFieldNode1);
		aController.removeSelected();
		aDiagram.draw(aGraphics);
		assertEquals(0, aObjectNode1.getChildren().size());
	...
	public void testDeleteEdge()
	{
		...
		aController.getSelectionList().add(aReferenceEdge2);
		aController.removeSelected();
		aController.getSelectionList().clearSelection();
		aDiagram.draw(aGraphics);
		assertEquals(2, aDiagram.getEdges().size());
		aController.getSelectionList().add(collaborationEdge1);
		aController.removeSelected();
		aController.getSelectionList().clearSelection();
		aDiagram.draw(aGraphics);
		assertEquals(1, aDiagram.getEdges().size());
	...
	public void testDeleteCombinationNodeAndEdge()
	{
		...
		aController.getSelectionList().add(aObjectNode1);
		aController.getSelectionList().add(assoEdge1);
		aController.getSelectionList().add(aReferenceEdge1);
		aController.getSelectionList().add(aReferenceEdge2);
		...
		aController.getSelectionList().add(aFieldNode2);
		aController.removeSelected();
		aController.getSelectionList().clearSelection();
		aDiagram.draw(aGraphics);
		assertEquals(2, aDiagram.getRootNodes().size());
