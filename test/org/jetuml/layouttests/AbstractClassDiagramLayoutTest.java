...
/**
 * Superclass for classes that test the layout of a class diagram. Declares
 * convenience methods to test diagram elements.
 */
public abstract class AbstractClassDiagramLayoutTest extends AbstractDiagramLayoutTest {

	AbstractClassDiagramLayoutTest(Path pDiagramPath) throws IOException {
		super(pDiagramPath);
	}
