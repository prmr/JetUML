...
public class TestJsonEncodingUseCaseDiagram {
	...
	/*
	 * Initializes a graph with two use cases with a extension dependency between
	 * them.
	 */
	...
	void testEncodeDecode2() {
		...
		UseCaseDependencyEdge edge = (UseCaseDependencyEdge) findEdge(graph, UseCaseDependencyEdge.class,
				build(PropertyName.USE_CASE_DEPENDENCY_TYPE, UseCaseDependencyEdge.Type.Extend));
