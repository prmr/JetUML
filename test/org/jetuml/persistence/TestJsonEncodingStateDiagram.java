...
public class TestJsonEncodingStateDiagram {
	...
	/*
	 * Initializes a simple graph with a start and end node, two state nodes, and
	 * individual transitions between them.
	 */
	...
	private void initDiagram2() {
		...
		aDiagram.addEdge(self1);
		self2.connect(node1, node1);
		aDiagram.addEdge(self2);
	...
	/*
	 * Initializes a graph with a node with two self-edges, and two transitions to a
	 * second node.
	 */
	...
	void testEncodeDecodeDiagram1() {
		...
		StateTransitionEdge edge1 = (StateTransitionEdge) findEdge(graph, StateTransitionEdge.class,
				build(PropertyName.MIDDLE_LABEL, "edge1"));
		StateTransitionEdge edge2 = (StateTransitionEdge) findEdge(graph, StateTransitionEdge.class,
				build(PropertyName.MIDDLE_LABEL, "edge2"));
		StateTransitionEdge edge3 = (StateTransitionEdge) findEdge(graph, StateTransitionEdge.class,
				build(PropertyName.MIDDLE_LABEL, "edge3"));
	...
	void testEncodeDecodeDiagram3() {
		...
		StateTransitionEdge self1 = (StateTransitionEdge) findEdge(graph, StateTransitionEdge.class,
				build(PropertyName.MIDDLE_LABEL, "self1"));
		StateTransitionEdge self2 = (StateTransitionEdge) findEdge(graph, StateTransitionEdge.class,
				build(PropertyName.MIDDLE_LABEL, "self2"));
		StateTransitionEdge edge1 = (StateTransitionEdge) findEdge(graph, StateTransitionEdge.class,
				build(PropertyName.MIDDLE_LABEL, "edge1"));
		StateTransitionEdge edge2 = (StateTransitionEdge) findEdge(graph, StateTransitionEdge.class,
				build(PropertyName.MIDDLE_LABEL, "edge2"));
