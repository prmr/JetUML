...
public class SerializationContextTest {
	...
	void testMaintainNodeOrder() {
		loadNodes();
		aContext = new SerializationContext(aDiagram);
		assertThat(nodesInsideContext(), hasElementsSameAs, aPackage1, aPackage2, aClassNode3, aClassNode2, aClassNode1,
				aNoteNode);
	}
	...
	void testMaintainNodeOrder2() {
		...
		aContext = new SerializationContext(aDiagram);
		assertThat(nodesInsideContext(), hasElementsSameAs, aClassNode1, aClassNode2, aClassNode3, aNoteNode, node1,
				node2);
	}
