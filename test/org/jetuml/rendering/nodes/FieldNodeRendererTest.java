...
public class FieldNodeRendererTest {
	...
	void testDimensionsUnattachedWithNameString() {
	...
	@Test
	@EnabledOnOs(OS.WINDOWS)
	void testDimensionsUnattachedWithValueString() {
	...
	@Test
	@EnabledOnOs(OS.WINDOWS)
	void testGetBoundsUnattachedNoStrings() {
		// x = axis (30) - offset (6)
		// y = 0
	...
	@Test
	@EnabledOnOs(OS.WINDOWS)
	void testGetBoundsUnattachedNameValueString() {
		aFieldNode1.setName("XXXXX");
		aFieldNode1.setValue("XXXXX");
	...
	@Test
	@EnabledOnOs(OS.WINDOWS)
	void testDimensionsAttachedNoStrings() {
	...
	@Test
	@EnabledOnOs(OS.WINDOWS)
	void testDimensionsAttachedObjectString() {
		aObjectNode1.addChild(aFieldNode1);
	...
	@Test
	@EnabledOnOs(OS.WINDOWS)
	void testDimensionsAttachedWithNameString() {
		aObjectNode1.addChild(aFieldNode1);
		aFieldNode1.setName("XXXXX");
		assertEquals(42, FieldNodeRenderer.leftWidth(aFieldNode1)); // The length of the string
		assertEquals(37, FieldNodeRenderer.rightWidth(aFieldNode1)); // Half the default width + mid offset.
	...
	@Test
	@EnabledOnOs(OS.WINDOWS)
	void testDimensionsAttachedWithValueString() {
		aObjectNode1.addChild(aFieldNode1);
		aFieldNode1.setValue("XXXXX");
		assertEquals(7, FieldNodeRenderer.leftWidth(aFieldNode1)); // Just the length of the mid offset
		assertEquals(42, FieldNodeRenderer.rightWidth(aFieldNode1)); // The length of the string
	...
	@Test
	@EnabledOnOs(OS.WINDOWS)
	void testGetBoundsAttachedNoStrings() {
		aObjectNode1.addChild(aFieldNode1);
