 ...
 *
 */
public interface GraphModificationListener2
{
	/**
	 ...
	 */
	void nodeAdded(Graph2 pGraph, Node pNode);
	 ...
	 */
	void nodeRemoved(Graph2 pGraph, Node pNode);
	 ...
	 */
	void edgeAdded(Graph2 pGraph, Edge pEdge);
	 ...
	 */
	void edgeRemoved(Graph2 pGraph, Edge pEdge);
