...
public class ToolBar extends JPanel
{
	...
	private void createSelectionTool(ButtonGroup pGroup, ButtonGroup pGroupEx)
	{
		installTool(IconCreator.createSelectionIcon(), 
				ResourceBundle.getBundle("ca.mcgill.cs.jetuml.framework.EditorStrings").getString("grabber.tooltip"), 
	...
	private void addCopyToClipboard()
	{
		URL imageLocation = getClass().getClassLoader().
				getResource(ResourceBundle.getBundle("ca.mcgill.cs.jetuml.framework.EditorStrings").
						getString("toolbar.copyToClipBoard"));
		String toolTip = ResourceBundle.getBundle("ca.mcgill.cs.jetuml.framework.EditorStrings").getString("file.copy_to_clipboard.text");
	...
	private void createExpandButton()
	{
		...
		final String expandString = ResourceBundle.getBundle("ca.mcgill.cs.jetuml.framework.EditorStrings").getString("toolbar.expand");
		final String collapseString = ResourceBundle.getBundle("ca.mcgill.cs.jetuml.framework.EditorStrings").getString("toolbar.collapse");
