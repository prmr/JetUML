...
public class EditorFrame extends JFrame
{
	...
	{  
		...
		aEditorResources = ResourceBundle.getBundle("ca.mcgill.cs.jetuml.framework.EditorStrings");      
   	...
   	public void saveAs()
   	{
   		...
   		try
   		{
   			...
   			if(response == JFileChooser.APPROVE_OPTION)
   			{
   				...
   				{
   	        		ResourceBundle editorResources = ResourceBundle.getBundle("ca.mcgill.cs.jetuml.framework.EditorStrings");
