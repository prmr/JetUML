 ...
 *
 */
public final class JsonDecoder2
{
	 ...
	 */
	public static Graph2 decode(JSONObject pGraph)
	{
		assert pGraph != null;
		try
		{
			Class<?> diagramClass = Class.forName(PREFIX_DIAGRAMS + pGraph.getString("diagram"));
			Graph2 graph = (Graph2) diagramClass.newInstance();
			DeserializationContext2 context = new DeserializationContext2(graph);
	 ...
	 */
	private static void decodeNodes(DeserializationContext2 pContext, JSONObject pObject)
	{
	 ...
	 */
	private static void restoreRootNodes(DeserializationContext2 pContext)
	{
	 ...
	 */
	private static void restoreChildren(DeserializationContext2 pContext, JSONObject pObject)
	{
		JSONArray nodes = pObject.getJSONArray("nodes");
		for( int i = 0; i < nodes.length(); i++ )
		{
	 ...
	 * throws Deserialization Exception
	 */
	private static void decodeEdges(DeserializationContext2 pContext, JSONObject pObject)
	{
