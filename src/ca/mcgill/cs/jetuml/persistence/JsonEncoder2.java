 ...
 *
 */
public final class JsonEncoder2
{
	private JsonEncoder2() {}
	
	/**
	 * @param pGraph The graph to serialize.
	 * @return A JSON object that encodes the graph.
	 */
	public static JSONObject encode(Graph2 pGraph)
	{
		assert pGraph != null;
		...
		SerializationContext2 context = new SerializationContext2(pGraph);
		object.put("nodes", encodeNodes(context));
		object.put("edges", encodeEdges(context));
		return object;
	}
	
	private static JSONArray encodeNodes(SerializationContext2 pContext)
	{
	...
	private static JSONObject encodeNode(Node pNode, SerializationContext2 pContext)
	{
	...
	private static JSONArray encodeChildren(Node pNode, SerializationContext2 pContext)
	{
	...
	private static JSONArray encodeEdges(AbstractContext2 pContext)
	{
