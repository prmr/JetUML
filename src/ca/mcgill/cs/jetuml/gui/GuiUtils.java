...
public final class GuiUtils
{
	...
	private static final int WIDTH_PADDING = 128; // Number of pixels of differences between stage and canvas width. Accounts for frame border.
	private static final int HEIGHT_PADDING = 128; // Number of pixesl of difference between stage and canvas height. Accounts for borders and menus.
	...
	{
		return defaultStageBounds().getWidth() - WIDTH_PADDING;
	}
