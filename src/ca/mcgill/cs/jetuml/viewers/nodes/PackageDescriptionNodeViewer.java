 ...
 */
public final class PackageDescriptionNodeViewer extends AbstractNodeViewer
{
	...
	public void draw(Node pNode, GraphicsContext pGraphics)
	{
		...
		NAME_VIEWER.draw(((PackageDescriptionNode)pNode).getName(), pGraphics, new Rectangle(topBounds.getX() + NAME_GAP, 
	 ...
	 */
	private Point getPosition(Node pNode)
	{
	...
	{
		Dimension nameBounds = NAME_VIEWER.getDimension(((PackageDescriptionNode)pNode).getName());
	...
	{
		Point position = getPosition(pNode);
