 ...
 *
 */
public interface ParentNode2 extends Node
{
	/**
	 * @return A list of the children of this node.
	 */
	List<ChildNode2> getChildren(); 
