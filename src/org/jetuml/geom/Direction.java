...
/**
 * This class describes an immutable direction in the 2D plane. The direction is
 * conceptually represented as an angle in degrees between 0 and 359
 * inclusively, where 0 represents "up" or "north", and where an increase in the
 * angle moves the direction clockwise. A direction can be expressed with a
 * precision of a maximum of one degree.
 */
@Immutable
@Flyweight
public final class Direction {
	...
	// CSOFF: These need to be below the DIRECTION fields to avoid
	...
	/**
	 * Returns the direction equivalent to the direction represented by the line
	...
	/**
	 * Returns a new direction that represents this direction turned clockwise
	 * by pAngle.
	 * 
	...
	/**
	 * Determines if this direction is strictly between the start and end
	 * directions. pStart and pEnd must be different. If they are at 180 degrees
	 * of each other this method returns false;
	 * 
	 * @param pStart The start direction (exclusive)
	 * @param pEnd The end direction (exclusive)
	 * @return True if this direction represents an angle between pStart
	 *     (exclusive) and pEnd (exclusive).
	...
	/**
	 * @return true if this direction has any value in the west cardinal
	 *     direction
	 */
	...
	/**
	 * @return true if this direction has any value in the east cardinal
	 *     direction
	 */
	...
	/**
	 * @return true if this direction has any value in the north cardinal
	 *     direction
	 */
	...
	/**
	 * @return true if this direction has any value in the south cardinal
	 *     direction
	 */
	...
	/*
	 * Computes an angle given a width an a height, so that angle 0 corresponds
	 * to pWidth=0 and pHeight > 0, in other words a vector pointing north.
	 */
