...
/**
 * A collection of utility methods related to geometric calculations and
...
public final class GeomUtils {
	...
	/*
	 * Returns the point that intersects the line that runs in direction
	 * pDirection from the center of pRectangle, with one side of pRectangle.
	 * 
	 ...
	 * @param pDirection The direction to follow to intersect the sides of the
	 *     rectangle.
	 * @return The point that intersects pRectangle if we draw a line from its
	...
	/**
	 * Returns the point that intersects a circle on the line that originates at
	 * the center of pBounds going in direction pDirection.
	 * 
	 * @param pBounds The bounds of the rectangle in which the circle to
	 *     intersect in inscribed.
	 * @param pDirection The direction to follow to intersect the sides of the
	 *     circle.
	 * @return The point that intersects the circle inscribed in pBounds if we
	 *     draw a line from its center going in direction pDirection.
	 * @pre pBounds != null && pDirection != null && pBounds.getWidth() ==
	 *     pBounds.getHeight()
	 */
	 ...
	 * 
	 * @param pBounds The bounds of the rectangle in which the ellipse to
	 *     intersect in inscribed.
	 * @param pDirection The direction to follow to intersect the sides of the
	 *     ellipse.
	 * @return The point that intersects the ellipse inscribed in pBounds if we
	 *     draw a line from its center going in direction pDirection.
	...
	/**
	 * @param pBounds The bounds of the rectangle in which the rounded rectangle
	 *     to intersect in inscribed.
	 * @param pDirection The direction to follow to intersect the sides of the
	 *     rounded rectangle.
	 * @return The point that intersects the rounded rectangle inscribed in
	 *     pBounds if we draw a line from its center going in direction pDirection.
	 * @pre pBounds != null && pDirection != null
	 */
	public static Point intersectRoundedRectangle(Rectangle pBounds, Direction pDirection) {
		...
		if (pDirection.isBetween(topNE, bottomNE)) {
			...
			result = new Point(pBounds.center().x() + offsetX + widthOffset,
					pBounds.center().y() + offsetY - heightOffset);
		}
	...
	/*
	 * returns the length, in pixel, of the opposing side to the angle
	 * pAngleInDegrees of a right triangle for when the length (in pixels) of
