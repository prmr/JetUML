 ...
 * 
 * @param point1 The first point in the line. Conceptually the "start" of the
 *     line. point1 != null
 * @param point2 The second point in the line. Conceptually the "end" of the
 *     line. point2 != null
 */
@Immutable
public record Line(Point point1, Point point2) {
	...
	/**
	 * A distance between points is the absolute difference between X-values
	 * expressed as a width and the absolute difference between Y-values
	...
	public Rectangle spanning() {
		return new Rectangle(min(x1(), x2()), min(y1(), y2()), abs(x2() - x1()), abs(y2() - y1()));
	}
}
