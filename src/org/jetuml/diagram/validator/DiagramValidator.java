...
public interface DiagramValidator {
	 ...
	 * 
	 * @return True if the content of the diagram does not violate any
	 *     structural or semantic rules.
	 */
	...
	/**
	 * Checks if any rule violates the correctness of this diagram. Returns the
	 * first violation detected, or empty if none are detected.
	 * 
