...
public class ObjectDiagramValidator extends AbstractDiagramValidator {
	...
	private static final Set<EdgeConstraint> CONSTRAINTS = Set.of(new ConstraintValidReferenceEdge(),
			new ConstraintValidCollaborationEdge(), new ConstraintNoSelfEdgeForEdgeType(ObjectCollaborationEdge.class),
	...
	private static final Set<Class<? extends Node>> VALID_NODE_TYPES = Set.of(ObjectNode.class, FieldNode.class);

	private static final Set<Class<? extends Edge>> VALID_EDGE_TYPES = Set.of(ObjectReferenceEdge.class,
