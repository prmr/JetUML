...
public class CallEdge extends SingleLabelEdge {
	...
	/**
	 * Determines if this edge is a self-edge. A self-edge has its start and end
	 * call nodes on the same implicit parameter node.
	 * 
	 * @return True if this a self-edge.
	 */
	public boolean isSelfEdge() {
		return end() instanceof CallNode && end().getParent() == start().getParent();
	}
}
