...
/**
 * An edge that that represents a UML dependency between use cases.
 */
public final class UseCaseDependencyEdge extends AbstractEdge {
	...
	public enum Type {
		...
		/**
		 * @return The label that corresponds to this association type.
		 */
	...
	protected void buildProperties() {
		...
		properties().add(PropertyName.USE_CASE_DEPENDENCY_TYPE, () -> aType,
				pType -> aType = Type.valueOf((String) pType));
	}
}
