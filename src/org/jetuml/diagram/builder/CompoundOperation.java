...
/**
 * An operation that is composed of other operations, following the Composite
 * Design Pattern.
 * 
 * Executing a compound operation executes all the sub-operations in the order
 * they were added. Undoing a compound operation undoes all the sub-operation in
...
public class CompoundOperation implements DiagramOperation {
	...
	/**
	 * @return True if this CompoundOperation contains no sub-operation.
	 */
