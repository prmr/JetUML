...
/**
 * Represents a simple (non-compound) operation. The operation does no
 * validation of the input method, so any code that constructs a SimpleOperation
 * is responsible to ensure that, when executed or undone, the operation will be
 * valid.
 */
