...
/**
 * Represents a property of an object as a tuple that consists of a name, a
 * getter for a value, and a setter for that value. The values managed by a
 * property should only be of immutable types.
 */
