...
public final class ClassNode extends TypeNode {
	...
	/**
	 * Constructs a new ClassNode with an empty name and no attributes or
	 * methods.
	 */
	public ClassNode() {
		setName("");
	...
	protected void buildProperties() {
		...
		properties().addAt(PropertyName.ATTRIBUTES, () -> aAttributes,
				pAttributes -> aAttributes = (String) pAttributes, 1);
	}
}
