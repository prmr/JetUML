 ...
 * object. Properties objects are intended to be constructed once, then queried
 * only.
 * 
 * This class provides support for storing properties in a meaningful order. By
 * default, this is the order of insertion. However, use of the method
 * <code>addAt</code> allows client code to insert a property at a specific
 * index. Keeping properties in order allows for uses such as displaying
 * properties in a predictable order, for instance in GUI forms.
 */
public class Properties implements Iterable<Property> {
	 ...
	 * @param pGetter The getter for this property.
	 * @param pSetter The setter for this property.
	 * @param pIndex Where to insert the property. Must be between 0 and
	 *     size()-1, inclusive.
	 * @pre pPropertyName != null && pGetter != null && pSetter != null &&
	 *     !containsKey(pName)
