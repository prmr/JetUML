...
public final class Prototypes {
	...
	public static final DiagramElement PACKAGE_DESCRIPTION = create(new PackageDescriptionNode(),
			"package_description");
	...
	public static final DiagramElement REALIZATION = create(
			new GeneralizationEdge(GeneralizationEdge.Type.Implementation), "realization");
	...
	public static final DiagramElement COMPOSITION = create(new AggregationEdge(AggregationEdge.Type.Composition),
			"composition");

	public static final DiagramElement IMPLICIT_PARAMETER = create(new ImplicitParameterNode(), "implicit_parameter");
	...
	public static final DiagramElement USE_CASE_ASSOCIATION = create(new UseCaseAssociationEdge(),
			"use_case_association");
	public static final DiagramElement USE_CASE_EXTENDS = create(
			new UseCaseDependencyEdge(UseCaseDependencyEdge.Type.Extend), "use_case_extends");
	public static final DiagramElement USE_CASE_INCLUDES = create(
			new UseCaseDependencyEdge(UseCaseDependencyEdge.Type.Include), "use_case_includes");
	public static final DiagramElement USE_CASE_GENERALIZATION = create(new UseCaseGeneralizationEdge(),
			"use_case_generalization"); // CSON:
