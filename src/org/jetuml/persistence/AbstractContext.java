...
/**
 * Base class for serialization and deserialization contexts. A context is a
 * mapping between nodes and arbitrary identifiers. The only constraint on
 * identifiers is that they consistently preserve mapping between objects and
 * their identity.
 */
