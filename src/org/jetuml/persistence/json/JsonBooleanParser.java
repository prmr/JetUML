...
/**
 * Parses boolean values in JSON document according to the ECMA-404 2nd edition
 * December 2017.
 */
final class JsonBooleanParser implements JsonValueParser {
	@Override
	public boolean isApplicable(ParsableCharacterBuffer pInput) {
		return pInput.isNext(Boolean.TRUE.toString().charAt(0)) || pInput.isNext(Boolean.FALSE.toString().charAt(0));
	}
