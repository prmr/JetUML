...
/**
 * A selectable button that wraps a creation tool represented by an object
 * prototype.
 */
public class SelectableToolButton extends ToggleButton implements BooleanPreferenceChangeHandler {
	...
	private Optional<DiagramElement> aPrototype = Optional.empty(); // If empty,
																	// indicates
																	// the
																	// "Select"
																	// tool
	...
	public SelectableToolButton(Canvas pIcon, String pToolTip, ToggleGroup pToggleGroup) {
		...
		getTooltip().setStyle("-fx-font-size: 100%"); // Override JavaFX
														// defaults
	...
	/**
	 * @return The prototype graph element to create new ones. isPresent() ==
	 *     false indicates that the Selection Tool is selected.
	 */
