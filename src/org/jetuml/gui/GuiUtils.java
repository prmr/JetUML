...
/**
 * A collection of utility methods to deal with general GUI concerns.
 */
public final class GuiUtils {

	private static final int MARGIN_SCREEN = 8; // Fraction of the screen to
												// leave around the sides
	private static final int WIDTH_PADDING = 32; // Nb. of pixels of difference
													// between stage and canvas
													// width. Accounts for frame
													// border.
	private static final int HEIGHT_PADDING = 128; // Nb. of pixels of
													// difference between stage
													// and canvas height.
													// Accounts for borders and
													// menus.
	private static final int TOOLBAR_WIDTH_COLLAPSED = 60; // Placeholder for
															// the toolbar in
															// collapsed mode
	private static final int TOOLBAR_WIDTH_EXPANDED = 150; // Placeholder for
															// the toolbar in
															// expanded mode
	...
	/**
	 * @return a bounding box that represents the default bounds of the main
	 *     stage. Finds the visual bounds of the primary screen and removes a
	 *     margin around it.
	 */
	public static Rectangle defaultStageBounds() {
		int screenWidth = (int) Screen.getPrimary().getVisualBounds().getWidth();
		int screenHeight = (int) Screen.getPrimary().getVisualBounds().getHeight();
		return new Rectangle(screenWidth / (MARGIN_SCREEN * 2), screenHeight / (MARGIN_SCREEN * 2),
