...
/**
 * Alert dialog specialized for displaying the various errors that can happen
 * when opening a file.
 */
public class DeserializationErrorAlert extends Alert {
	...
	public DeserializationErrorAlert(Exception pException) {
		...
		StringBuilder contentText = new StringBuilder(
				RESOURCES.getString(ROOT_RESOURCE_KEY_SUFFIX + keySuffix + DETAILS_SUFFIX));
		contentText.append(" ").append(RESOURCES.getString("alert.error.details")).append(" ")
