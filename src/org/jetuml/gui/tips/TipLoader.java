...
final class TipLoader {
	...
	public static final class Tip {
		 ...
		 * @param pTip the JSONObject obtained from the file tip-pId.json, where pId is
		 *             the same as the pId parameter.
		 */
		...
		/**
		 * @param pTip A JsonObject obtained from the JsonArray gotten by loading the
		 *             tips.
		 */
		...
		/*
		 * A tip content contains one property whose name is any Media value in lower
		 * case: discover which one it is.
		 */
		...
		/*
		 * A tip view contains one property whose name is any View value in lower case:
