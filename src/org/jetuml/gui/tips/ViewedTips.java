/*******************************************************************************
 * JetUML - A desktop application for fast UML diagramming. Copyright (C) 2025 by McGill University. See:
 * https://github.com/prmr/JetUML This program is free software: you can redistribute it and/or modify it under the
...
/**
 * Class holding the tip id logic related to generating the next or previous tip
 * ids and the id of the new next tip of the day.
 */
public class ViewedTips {
    ...
    /**
     * Checks if the tip of the day's id has been reached, and if so, updates the id
     * of the next tip of the day to the next id.
     */
