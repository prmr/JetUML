...
public final class MoveTracker {
	 ...
	 * 
	 * @param pBoundsCalculator A function to return the bounds of a diagram
	 *     element.
	 */
	...
	/**
	 * Creates and returns a CompoundOperation that represents the movement of
	 * all tracked nodes between the time where startTrackingMove was called and
	 * the time endTrackingMove was called.
	 * 
