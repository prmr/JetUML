 ...
 * underlying canvas. Instances of this class are intended to be used in a
 * narrow scope: to be initialized, used to perform calculations, then
 * discarded. Both dimensions of the viewport must be equal to or smaller than
 * the canvas's.
 */
@Immutable
public final class ViewportProjection {
	 ...
	 * @param pHValue The horizontal position of the viewport over the canvas,
	 *     from 0 to 1.
	 * @param pVValue The vertical position of the viewport over the canvas from
	 *     0 to 1.
	 */
	...
	/**
	 * @return The number of pixels on the left of the canvas that are not
	...
	/**
	 * @return The number of pixels on the right of the canvas that are not
	 *     visible in the viewport.
	 */
	...
	/**
	 * @return The number of pixels at the top of the canvas that are not
	 *     visible in the viewport.
	 */
	...
	/**
	 * @return The number of pixels at the bottom of the canvas that are not
	 *     visible in the viewport.
	 */
	 ...
	 * @return A newly computed HValue that will ensure pX is just visible in
	 *     the viewport.
	 */
	 ...
	 * @return A newly computed VValue that will ensure pY is just visible in
	 *     the viewport.
	 */
