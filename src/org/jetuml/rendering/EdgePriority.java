...
/**
 * Represents the priority level for edges so that Layouter can lay out edges in
 * a hierarchical order. Arranged in decreasing order of priority (INHERITANCE
 * has the highest priority)
 */
public enum EdgePriority {
	INHERITANCE, IMPLEMENTATION, AGGREGATION, COMPOSITION, ASSOCIATION, DEPENDENCY, SELF_EDGE, OTHER;
	...
	/**
	 * Returns whether pPriority describes a segmented edge. Since Layouter plans
	 * the paths of self-edges separately, self-edges are not segmented by this
	 * method.
	 * 
	 * @param pPriority the EdgePriority level of interest
	 * @return true if the pPriority is the priority for a segmented edge, false
	 *         otherwise
	 * @pre pPriority!=null;
	 */
	...
	/**
	 * Returns whether pEdge is a class diagram Edge which can be stored in
	 * EdgeStorage by Layouter.
	 * 
	 * @param pEdge the edge of interest
