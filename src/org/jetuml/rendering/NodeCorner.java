...
public enum NodeCorner {
	...
	/**
	 * Gets the Direction (either North or South) describing pCorner's horizontal
	 * position on a node.
	 * 
	 * @param pCorner the node corner of interest
	 * @return TOP if the corner is a top corner, BOTTOM if the corner is a bottom
	 *         corner.
	 * @pre pCorner != null;
	 */
	...
	/**
	 * Gets the Direction (either RIGHT or LEFT) describing pCorner's vertical
	 * position on a node.
	 * 
	 * @param pCorner the node corner of interest
	 * @return RIGHT if the corner is a right corner, LEFT if the corner is a left
	 *         corner.
	 */
