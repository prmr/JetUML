...
public final class ArrowHeadRenderer {
	 ...
	 * @param pAxis      A line in the direction of the arrow ending a
	 *                   pAxis.getPoint2()
	 */
	...
	private static Rectangle toRectangle(Bounds pBounds) {
		assert pBounds != null;
		return new Rectangle((int) pBounds.getMinX(), (int) pBounds.getMinY(), (int) pBounds.getWidth(),
				(int) pBounds.getHeight());
	}
}
