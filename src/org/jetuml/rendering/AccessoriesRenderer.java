...
public class AccessoriesRenderer {
	...
	/**
	 * Draws a "lasso" rectangle. A lasso rectangle is a semi-transparent rectangle
	 * in the color of the selection tools.
	 * 
	...
	/**
	 * Draws four handles on pGraphics centered at the four corners of pBounds.
	 * 
	...
	/**
	 * Draws two handles on pGraphics centered at the two ends of pBounds.
	 * 
	...
	/*
	 * Draws a handle on pGraphics that is centered at the position (pX, pY).
	 * 
